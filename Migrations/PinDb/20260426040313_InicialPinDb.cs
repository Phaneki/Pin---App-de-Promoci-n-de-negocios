...
{
    /// <inheritdoc />
    public partial class InicialPinDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffLogs", x => x.LogId);
                    table.ForeignKey(
                        name: "FK_StaffLogs_Users_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessMetrics", x => x.MetricId);
                    table.ForeignKey(
                        name: "FK_BusinessMetrics_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "BusinessId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessProduct", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_BusinessProduct_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "BusinessId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessReports", x => x.ReportId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessReports_Users_ReporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessSchedule", x => x.ScheduleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessMetrics_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessReports_ReporterId",
                table: "BusinessReports",
                column: "ReporterId");
